...
void RoundUpGrades( Student & student ) {
  if ( student.q4Correct == 12 ) {
    ...
    student.grade = 57.5 + student.q4Correct * 1.041;
  } // if: pass q3

  else if ( student.q2Correct == 14 ) {
    student.grade = 40 + student.q3Correct * 1.093 + student.q4Correct * 1.041;
  } // if: pass q2

  else if ( student.q1Correct == 12 ) {
    student.grade = 15 + student.q2Correct * 1.785 + student.q3Correct * 1.093 +
                    student.q4Correct * 1.041;
  } // if: pass q2

  else {
    student.grade = student.q1Correct * 1.25 + student.q2Correct * 1.785 +
                    student.q3Correct * 1.093 + student.q4Correct * 1.041;
...
void Output_Student_Grades( vector<Student> allStudents ) {
  ofstream output;
  output.open( "110-2-FinalGrades.txt" );
...
int main() {
  ...
  file.open( "0630-PL110-2-FinalAnsweringRecords.txt" );
